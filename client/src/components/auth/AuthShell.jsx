...
const shellContent = {
  login: {
    title: 'A place for meaningful conversations',
    description: 'Kura helps you reconnect with your community, pick up trusted conversations, and move through your workspace with clarity.',
    featureLabel: 'Live conversations',
    trustLabel: 'Privacy first',
    supportLabel: 'Help when needed',
    searchPlaceholder: 'Search conversations',
    contactName: 'Veronica Jones',
    statusText: 'Active now',
    incomingMessage: "Hey! Hope you're having a wonderful day.",
    outgoingMessage: 'Thanks! Just checking in before we chat later.',
    typingLabel: 'Veronica is typing...'
  },
  register: {
    title: 'Start your circle with confidence',
    description: 'Create your Kura account to build trusted chats, shape your profile, and step into a calmer messaging space from day one.',
    featureLabel: 'Fast onboarding',
    trustLabel: 'Secure identity',
    supportLabel: 'Guided setup',
    searchPlaceholder: 'Find your people',
    contactName: 'Welcome circle',
    statusText: 'Ready to connect',
    incomingMessage: 'Welcome to Kura. Your space is ready whenever you are.',
    outgoingMessage: 'Perfect. I am setting up my profile and inviting my people.',
    typingLabel: 'Preparing your first conversation...'
  }
};

const AuthShell = ({ children, mode = 'login' }) => {
  const content = shellContent[mode] || shellContent.login;
        ...
        <section className="grid w-full items-center gap-10 lg:grid-cols-[minmax(0,1.05fr)_minmax(420px,0.95fr)]">
          ...
          <div className="grid items-center gap-8 lg:grid-cols-[minmax(320px,380px)_minmax(260px,1fr)]">
            ...
            <div className="relative order-1 hidden min-h-[480px] animate-fadeIn lg:block lg:order-2">
              <div className="absolute left-8 top-4 flex h-20 w-20 animate-[floatY_6s_ease-in-out_infinite] items-center justify-center rounded-[2rem] bg-[linear-gradient(135deg,#a154ff_0%,#456cff_55%,#1dd9d2_100%)] shadow-lg shadow-cyan-200/30">
                <span className="text-3xl">?</span>
              </div>

              <div className="absolute right-0 top-8 w-[255px] animate-[floatY_7s_ease-in-out_infinite_0.4s] rounded-[2rem] bg-white/82 p-4 shadow-[0_30px_80px_-30px_rgba(91,43,198,0.34)] ring-1 ring-brand-100 backdrop-blur">
                ...
                <div className="rounded-2xl bg-[linear-gradient(135deg,rgba(245,239,255,0.9),rgba(232,249,255,0.9))] px-4 py-3 text-sm text-slate-500">{content.searchPlaceholder}</div>
              ...
              <div className="absolute bottom-0 left-0 w-[290px] animate-[floatY_8s_ease-in-out_infinite_0.8s] rounded-[2rem] bg-[linear-gradient(180deg,rgba(245,239,255,0.96)_0%,rgba(221,235,255,0.96)_52%,rgba(221,255,251,0.94)_100%)] p-4 shadow-[0_30px_80px_-30px_rgba(91,43,198,0.38)] ring-1 ring-brand-100">
                <div className="flex items-center justify-between">
                  <div>
                    <p className="text-sm font-semibold text-slate-900">{content.contactName}</p>
                    <p className="text-xs text-slate-500">{content.statusText}</p>
                  </div>
                ...
                <div className="mt-5 space-y-3 text-sm">
                  ...
                  <div className="rounded-2xl bg-white px-4 py-3 shadow-sm">
                    <div className="rounded-2xl bg-[linear-gradient(135deg,#311f61,#23336a,#0e7490)] px-4 py-3 text-white">
                      <div className="text-sm font-medium">{content.typingLabel}</div>
              ...
              <div className="absolute bottom-24 right-[-0.5rem] h-16 w-16 animate-[pulseGlow_5s_ease-in-out_infinite] rounded-[1.5rem] bg-accent-200/80 blur-[1px]" />
            </div>
          </div>
        </section>
      </div>
